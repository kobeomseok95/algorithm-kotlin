...
fun main() {
    ...
    val root1 = `102`.TreeNode(3).apply {
        left = `102`.TreeNode(9)
        right = `102`.TreeNode(20).apply {
            left = `102`.TreeNode(15)
            right = `102`.TreeNode(7)
        }
    }
    println(solution.levelOrder(root1)) // [[3],[9,20],[15,7]]

    // Example 2: root = [1]
    val root2 = `102`.TreeNode(1)
    ...
    val root4 = `102`.TreeNode(1).apply {
        left = `102`.TreeNode(2).apply {
            left = `102`.TreeNode(4)
            right = `102`.TreeNode(5)
        }
        right = `102`.TreeNode(3).apply {
            left = `102`.TreeNode(6)
            right = `102`.TreeNode(7)
        }
    }
